...
# 附录 F：2026-08-04 新增公众号材料（玉树 / 心项目）

用户在本次会话粘贴两篇已发布公众号全文。完整提炼与可公开/不可放大边界已存于：

```text
docs/content-source/2026-08-wechat-yushu-qinling-updates.md
```

必须记住：玉树新增“玉树·悟心｜雪域相伴，支教知暖”支教日记 3；心项目新增“秦岭青苗计划”，三天课程为青山守护、生灵探秘、非遗匠心。后续网站、视频、成果材料引用这两篇时，优先读该来源文件，避免只沿用早期“净山 / 研学 / 问村”的旧简述。
