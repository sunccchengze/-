...
export const newcomerPath = {
  ...
  promise: "先认真了解，再填报志愿；面试通过后，从干事开始，在部长和副社带领下参与部门活动。",
  steps: [
...
export const leadership = {
  ...
  presidentMessage: {
    ...
    title: "社长",
    quote:
      "欢迎你来英仔。这里有走进乡村课堂的热忱，也有陪伴长者、儿童与更多人的耐心；有镜头后的记录，也有活动现场的协作。新一届社长团会把助学、敬老、特殊儿童关怀、生态保护和文博服务一件件做扎实，也会把每一位新干事的第一次认真接住。愿你在英仔找到愿意并肩的人，在一次次真实行动里学会担当、表达与成长。",
    note: "",
  },
  coreTitle: "社长团成员",
  core: [
...
export const about = {
  ...
  paragraphs: [
    ...
    "品牌项目以十年计：**玉树支教**已走到第**十七**届；「**知行秦川**」由前卫（九峰）与洩湖（彬州）双线并行。历年故事曾被《人民日报》《光明日报》《陕西日报》等关注。**2026**，我们面向 **2026 级**，等你一起出发。",
  ],
};
...
export const whyJoin = [
  {
    ...
    title: "方向多，参与有章法",
    description:
      "助学、文博、敬老、环保、儿童关怀等方向持续开展。多数部门通常两周一次例会，学期内平均每周约 2—4 小时；具体安排会随部门与活动节点调整。"
  },
  {
    icon: Trophy,
    title: "五星级 × 硬荣誉",
...
export const departmentsIntro = {
  ...
  observerNote: "旁听制度：仅宣传部、常务部录取的新干事可在首次破冰例会上选择一个旁听部门，开放前卫、洩湖、向日葵、常青藤四个方向。旁听由部长协调确定；旁听干事在材料与活动任务上基本与该部门干事同等参与，但正式归属仍在宣传部或常务部。举例：有同学 2025 年作为宣传部干事旁听前卫，2026 年竞选为宣传部部长后，仍跟随前卫参加周至支教。",
  /** 外行人友好：助学线 / 敬老线一句话 */
  legend: [
...
export const faqs = [
  ...
  },
  {
    question: "每周大概要花多少时间？",
    answer:
      "多数部门通常两周召开一次例会，学期内平均每周约 2—4 小时；不同部门和活动节点会有变化。寒暑期实践的时间安排会更集中，具体以部门实际通知为准。",
  },
  {
  ...
  },
  {
    question: "什么是旁听制度？",
    answer:
      "旁听仅面向宣传部、常务部录取的新干事。在首次破冰例会上，由部长组织大家从前卫、洩湖、向日葵、常青藤中选择一个旁听部门；旁听干事会和该部门其他干事一起写材料、做活动，但正式归属仍在宣传部或常务部。交流部及其他项目部门不开放旁听。",
  },
  {
    question: "除了本部门活动，还有全社或全校机会吗？",
    answer:
      "有，但以每次招募通知为准。晨星助学是学期内的周常助学活动，全社成员可报名；冬至饺子宴、春游等交流部社内活动面向全社。玉树支教团面向全校正式招募并进行面试，社内成员因更熟悉项目会更容易做好准备。",
  },
  {
    question: "志愿活动多吗？能积累多少服务时长？",
    answer:
      "各部门都有稳定的活动方向：助学、文博、敬老、儿童关怀、环保与校园公益等。进入部门后以本部门管理的活动为主；社团会如实记录每次志愿服务经历，具体参与安排以部门和活动通知为准。",
  },
  {
    question: "「前卫」「洩湖」是什么？和大手拉小手什么关系？",
    answer:
      "「大手拉小手」是助学线。前卫部主要对接周至九峰，洩湖部主要对接文姬、彬州等并组织大学游；暑期「知行秦川」也按这两条线分队。选部时看你想长期服务哪一所学校、哪一类孩子即可。",
  },
  {
    question: "五星级社团意味着什么？",
    answer:
