...
export const summerSection = {
  ...
  title: "2026 暑假，我们在路上",
  subtitle:
    "2026 年 7 月：玉树第十七届再赴雪域；知行秦川在九峰与彬州双线开营；萤火、秦岭与中原文脉同步出发。",
};
...
export const summerCards: SummerCard[] = [
  {
    ...
    beats: [
      ...
      "品牌底色：自 2010 驰援起航，一届届把西迁温情送到三江源头（去年亦曾以数十人规模服务当地孩子）",
    ],
    story:
...
export const summerMore = [
  ...
  {
    name: "青春伴夕阳 · 银龄方向",
    desc: "向日葵 / 常青藤：社区医养、适老化调研与敬老陪伴，暑期与学期活动相连",
  },
  {
    name: "陕博部 · 暑期志愿联队",
    desc: "2026 暑期陕历博讲解与民族融合专题路线，在展厅讲好长安故事",
  },
];
