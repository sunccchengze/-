...
export const about = {
  ...
  paragraphs: [
    ...
    "本学年共有 **199** 名社员，**3** 个职能部门 + **8** 个项目部门，覆盖支教助学、敬老陪伴、特殊儿童关怀、文博志愿、校园公益与生态环保。从秦岭脚下的教室到雪域高原的课堂，从陕博展厅到病房床边——我们搭建连接校园与社会的公益平台。",
...
export const honorVault = [
  ...
  { level: "校级", title: "学雷锋志愿服务优秀项目", detail: "薪火传史·文博 / 萤火聚爱·童梦护航", image: "/images/荣誉/荣誉12.jpg" },
] as const;
