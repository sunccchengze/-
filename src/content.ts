...
export const trustBar = [
  { label: "校级五星级社团", detail: "与连续优秀社团荣誉并列的平台底色" },
  { label: "志愿活动很丰富", detail: "支教、讲解、敬老、环保，常年有出发" },
...
/**
 * 第十六届社长团（换届推送定稿）
 * 来源：社长团换届 | 薪火赓续守初心 爱心接力启新程
 * 不展示手机/学号
 */
export const leadership = {
  eyebrow: "OUR TEAM",
  title: "认识这一届英仔",
  subtitle: "第十六届社长团 · 仲英书院业务指导 · 指导老师刘晗梦",
  advisor: { name: "刘晗梦", title: "指导老师", unit: "仲英书院" },
  advisorNote: "换届会上沈永锡老师、刘晗梦老师寄语新一届团队",
  presidentMessage: {
    name: "王晗宇",
    title: "第十六届社长",
    /** 据换届表态整理；若有社长书面全文可再替换 quote */
    quote:
      "我们将传承英仔爱心社的优良传统，统筹协调、凝心聚力，聚焦助学助老、特殊儿童关怀、生态保护、文博服务等核心领域，优化活动质量、规范内部管理、扩大公益覆盖，带领社团在志愿服务道路上稳步前行。",
    note: "",
  },
  /** 标题展示用 */
  coreTitle: "社长团成员",
