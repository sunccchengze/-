...
/** 面向新生的低压力加入路径：先体验，再决定深度参与。 */
export const newcomerPath = {
  eyebrow: "YOUR FIRST STEP",
  title: "第一次加入，也可以很轻松",
  subtitle: "不需要一开始就确定全部方向。先认识伙伴、体验一次真实活动，再选择适合自己的节奏。",
  promise: "从第一次体验，到长期项目；在自己的节奏里，找到属于你的公益位置。",
  steps: [
    { number: "01", title: "先认识", desc: "招新现场、招新群或轻松交流里，先把部门、时间和自己在意的问题问清楚。" },
    { number: "02", title: "先体验", desc: "从一次活动、一次培训或一次旁听开始，看看真实的项目现场是否适合你。" },
    { number: "03", title: "有人带", desc: "新生从干事开始，跟着部长、干事伙伴和项目负责人慢慢熟悉活动流程。" },
    { number: "04", title: "再选择", desc: "课业优先，结合自己的时间与兴趣决定稳定参与、旁听体验或寒暑期投入。" },
  ],
};
...
export const summerCards: SummerCard[] = [
  {
    ...
    newcomerEntry: "你可以从课程准备、物资整理、校内助学或一次项目分享会开始，慢慢走近高原课堂。",
  ...
  },
  {
    ...
    newcomerEntry: "你可以先旁听一次助学活动、参与课程准备或活动记录，再决定是否长期陪伴一所学校。",
  ...
  },
  {
    ...
    newcomerEntry: "儿童关怀从培训、物料准备和团队协作开始；尊重服务对象，也尊重自己的成长节奏。",
  ...
  },
  {
    ...
    newcomerEntry: "你可以从校内回收、一次净山体验或生态宣讲准备开始，把关心环境变成可做的行动。",
    tags: ["2026.7", "心项目", "秦岭"],
  },
];
...
export const whyJoin = [
  {
    ...
    title: "机会多，节奏由你安排",
    description:
      "助学、文博、敬老、环保、儿童关怀等方向常年有机会。你可以在课业和生活节奏允许时，选择感兴趣的活动认真参与；每一次出发都会被如实记录。"
  },
  {
    icon: Trophy,
    title: "五星级 × 硬荣誉",
...
export const departmentsIntro = {
  ...
  observerNote: "旁听制度：宣传部、常务部干事可在主部门之外旁听一个项目部门，体验另一方向的活动。举例：有同学 2025 年作为宣传部干事旁听前卫，2026 年竞选为宣传部部长后，仍跟随前卫参加周至支教。",
  /** 外行人友好：助学线 / 敬老线一句话 */
  legend: [
...
export const faqs = [
  ...
  {
    question: "第一次加入，会先做什么？",
    answer:
      "先在招新群或轻松交流里了解方向和时间，再参加一次真实活动、培训或旁听体验。你不需要一开始就确定全部安排；先看看现场、认识伙伴，再选择适合自己的参与节奏。",
  },
  {
    question: "可以同时了解两个部门吗？",
    answer:
      "可以。宣传部、常务部干事可通过旁听制度体验一个项目部门的活动；其他同学也可以先在招新阶段多问、多看，再决定主要参与方向。社团内会从干事开始，逐步成长为部长、副社。",
  },
  {
    question: "第一次活动有人带吗？",
    answer:
      "会有。第一次体验通常由部门负责人和高年级伙伴说明流程、分配任务，并在活动中协助你熟悉节奏。遇到不懂的地方直接问，不需要把自己当成已经很有经验的人。",
  },
  {
    question: "志愿活动多吗？能积累多少服务时长？",
    answer:
      "方向很多：线上助学、陕博讲解、敬老、儿童关怀、净山和校内公益都会陆续开展。你可以结合课业与自己的时间选择参与；社团会如实记录每次志愿服务经历。",
  },
  {
