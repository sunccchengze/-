...
export const hero = {
  ...
  highlights: ["校级五星级", "志愿时光很充实", "199 人在路上"],
  primaryCta: "我想加入",
  secondaryCta: "先看看故事",
...
/** 首屏下方信任条：五星 + 工时丰富度 + 书院指导（不提综测） */
export const trustBar = [
  { label: "校级五星级社团", detail: "与「连续优秀社团」并列的硬底色" },
  { label: "志愿时光很充实", detail: "支教、讲解、敬老、环保……出发很多" },
...
export const leadership = {
  eyebrow: "OUR TEAM",
  title: "认识这一届英仔",
  subtitle: "仲英书院业务指导 · 指导老师刘晗梦",
  advisor: { name: "刘晗梦", title: "指导老师", unit: "仲英书院" },
  presidentMessage: {
    name: "王晗宇",
    title: "社长",
    /** 占位寄语：你拿到社长原文后，只改 quote 字段即可 */
    quote:
      "如果你也想把大学里的某一些周末，过成「被需要」的样子——欢迎来英仔。我们不一定每次都完美，但每一次出发都认真。雪山、教室、展厅与病房，都有英仔的脚印；下一串，可以是你的。",
    note: "（寄语待社长审定后替换）",
  },
  core: [
    { name: "王晗宇", role: "社长" },
...
export const about = {
  ...
  title: "关于英仔爱心社",
  paragraphs: [
    "「英」为爱，「仔」一起。西安交通大学英仔爱心社成立于 2010 年，是学生自愿组成的校级五星级公益社团，也是全国唯一由非唐仲英奖学金获得者组成的唐仲英爱心社。我们以「服务社会、奉献爱心、推己及人、薪火相传」为宗旨，把课堂外的青春，写成可被触摸的陪伴。",
    "本学年约 199 名成员，3 个职能部门 + 8 个项目部门，覆盖支教助学、敬老陪伴、特殊儿童关怀、文博志愿、校园公益与生态环保。从秦岭脚下的教室到雪域高原的课堂，从陕博展厅到病房床边——我们搭建连接校园与社会的公益平台。",
    "品牌项目以十年计：玉树支教已走到第十七届；「知行秦川」由前卫（九峰）与洩湖（彬州）双线并行。历年故事曾被《人民日报》《光明日报》《陕西日报》等关注。2026 秋季，我们面向 2026 级，等你一起出发。",
  ],
};
...
/** 第二排：更「有张力」的关键数字（答辩材料口径） */
export const statsSecondary = [
  { value: "5", label: "本学年国家级荣誉", hint: "榜样100 社团+团队、西门子、立邦等" },
...
export const statsFooter =
  "近两千人次参与 · 五星级社团 × 红旗团支部 · 秦川双线（九峰 / 彬州）";
/* ───────── 暑期实践 Spotlight ───────── */
...
export const summerSection = {
  eyebrow: "SUMMER PRACTICE",
  title: "这个夏天，我们在路上",
  subtitle:
    "把 2025 与 2026 两个暑假叠在一起看：玉树第十七届再赴雪域；知行秦川在九峰与彬州双线开营；萤火、秦岭、中原文脉同步出发。",
};
...
export const summerCards: SummerCard[] = [
  {
    ...
    dept: "玉树支教团（跨部组建）",
    title: "梦绽格桑原，玉树支教团",
    poetic: "十七载薪火，两度暑假——把美育、科学与陪伴写在雪域讲台上",
    place: "青海玉树 · 称多县文乐中心寄宿学校",
    image: IMG_暑期_玉树,
    stats: [
      { value: "17", label: "届接力" },
      { value: "25", label: "2025 志愿者" },
      { value: "200+", label: "2025 志愿小时" },
    ],
    beats: [
      "溯源：2010 玉树地震驰援起航，西迁温情送到三江源头",
      "2025 暑假：第十五届口径材料记 25 名志愿者、200+ 小时、服务约 700 名当地小学生",
      "2026 暑假：第十七届再赴称多文乐——北门集结 → 西宁休整 → 十余小时进山",
      "破冰「玉树相逢，共绽格桑」：藏语问候、心愿卡、击鼓传花、汉藏歌声互答（破冰现场 230+ 同学）",
      "课堂：美育 / 体育分层 / 健康自护 / 科学 / 音乐；主题「心向暖阳，格桑绽放」+ 非遗水拓漆扇",
    ],
    story:
      "两届暑假连在一起读，才读得懂「接力」。2025，队伍把美术、音乐、体育带上高原；2026，第十七届再次整装向西。高原上的第一堂课总带着试探的羞涩——当第一种声音被听见，陪伴便真正开始。支教日记里有「自山而来，向山而行」，也有孩子一句「好羡慕你的父母都还健在」敲开的沉默。",
    tags: ["榜样100 团队", "立邦支教奖", "民族团结", "西迁精神"],
  },
  {
    id: "qinchuan",
    tier: "hero",
    ...
    dept: "前卫部 × 洩湖部",
    title: "知行秦川，梦启今夏",
    poetic: "同一面旗帜，两所中学：九峰 11 人带 45 名营员；彬州 6 人陪伴约 60 名同学",
    place: "周至九峰中学 · 咸阳彬州中学",
    image: IMG_暑期_知行秦川,
    stats: [
    ...
    beats: [
      "【前卫 · 九峰 · 2026】11 名志愿者 · 约 45 名营员；破冰猜词与击鼓传花",
      "【前卫 · 课堂】拓扑、心理、语文戏剧、趣味化学、英语剧与配音、航发科普、体育手工游园会",
      "【洩湖 · 彬州 · 2026】6 名志愿者 · 约 60 名同学：家乡介绍、高三心路、专业科普、环保与普法",
      "【洩湖 · 收官】西迁精神、水墨美育、心理健康、「我眼中的交大」",
      "与日常「大手拉小手」线上助学、大学游咬合——暑期不是孤岛（2025 全队约 27 人可作对照）",
    ],
    story:
      "「知行秦川」从来不是一支模糊的队伍：前卫扎根周至九峰，用夏令营打开初中生的眼界与笑声；洩湖走进彬州中学，面向高中生做经验、专业与美育的深度对话。开营时承诺很轻——「愿做孩子们探索世界的一扇小窗」——收官时的告别会却很重。",
    tags: ["西门子爱绿", "立邦支教", "前卫部", "洩湖部"],
  },
  {
    id: "yinghuo-summer",
    tier: "support",
    ...
    story:
      "萤火的暑期不是单场活动，而是一条连续的关怀链：在西北妇女儿童医院把床头小桌变成画板；在千千爱完成从培训到收官的多日陪伴；在菊花园与香胡湾教孩子识别情绪、赞美同伴。微光分散在不同门牌号上，却同属一个名字。",
    tags: ["萤火连心桥", "金丝带 / 千千爱", "阳光社工"],
  },
  {
    id: "qinling",
    tier: "support",
    ...
    beats: [
      ...
      "秦岭野生动物园 & 陕西自然博物馆沉浸研学",
      "朱家湾党建与民宿访谈：生态保护如何托起乡村振兴",
    ],
    story:
      "心项目的秦岭线既有弯腰捡起的塑料瓶，也有走进展厅与山村的提问。书本里的绿水青山，要走到山野间才作数；个人力量虽小，微光汇入街道—高校—协会的共建，就能为子午峪减负、为山河长青发声。",
    tags: ["心项目", "无痕山野", "三下乡"],
  },
];
...
export const summerMore = [
  {
    name: "启明星 · 启明寻洛，脉续中原",
    desc: "洛阳：隋唐城·龙门石窟·洛博·二里头；开封：清明上河园与万岁山——用青年脚步读文旅活化",
  },
  {
    name: "青春伴夕阳 · 银龄调研",
    desc: "向日葵 / 常青藤线：社区医养、适老化与敬老日常，暑期调研与学期陪伴衔接",
  },
  {
    name: "陕博部 · 寒暑假志愿联队",
    desc: "陕历博讲解与民族融合专题路线，讲好长安故事",
  },
];
...
export const whyJoin = [
  ...
  },
  {
    ...
    title: "从旁听到独当一面",
    description:
      "策划、招募、带队、宣讲、写总结——职能部门练统筹，项目部门练落地。宣传部系统学影像与新媒体，零基础也有人带。",
  },
  {
    icon: Home,
    title: "有人叫你一声「英仔」",
...
export const projectDepartments: Department[] = [
  {
    name: "前卫部",
    image: IMG_前卫部,
    positioning: "九峰助学主场，知行秦川·前卫线的操盘手",
    brandNote: "大手拉小手 · 前卫线",
...
export const departmentsIntro = {
  ...
  footer: "职能部门可旁听项目部；项目部深耕一条公益线。不确定？招新群里学长学姐都在。",
  /** 外行人友好：品牌线一句话 */
  legend: [
...
export const platforms = [
  {
    ...
    blurb: "本学年 186 篇推送，活动预告与志愿故事的大本营",
    link: LINK_微信公众号,
  },
  {
  ...
  },
  {
    ...
    detail: "英仔爱心社",
    metric: "新阵地 · 19 条起步",
    blurb: "短视频讲现场与故事——欢迎会拍会剪的你一起来把号养起来",
    link: LINK_抖音号,
  },
];
...
export const faqs = [
  ...
  },
  {
    question: "每周大概要花多少时间？",
    answer:
      "多数部门周常在 2–4 小时（例会 + 活动），寒暑假实践与大型节点会更集中。我们尊重课业节奏，也会在招新时把各部时间画像说清楚。",
  },
  {
    question: "可以同时待在多个部门吗？",
    answer:
      "宣传部、常务部同学可以再旁听一个项目部门；其他同学以一个部门深度参与为主，以保障对服务对象的稳定陪伴与活动质量。",
  },
  {
...
export const joinSteps = [
  ...
  { step: "02", title: "轻松交流", desc: "短面试只为互相了解——不是淘汰赛。" },
...
export const footer = {
  credit: "宣传部 · 2026 秋季招新官网",
  rights: "© 2026 西安交通大学英仔爱心社 · 校级五星级公益社团",
  contact: "业务指导：仲英书院 · 指导老师刘晗梦 · 公众号留言即可联系我们",
