      ...
      <div className="relative aspect-video overflow-hidden bg-[#221513]">
        {playable ? (
          ...
          <>
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#211310]/75 via-[#211310]/10 to-transparent" />
            <div className="absolute bottom-5 left-6 right-6 z-10">
              <p className="font-serif-cn text-2xl font-bold tracking-[0.08em] text-white">{title.includes("玉树") ? "十七年，我们还在赴约" : "把那个夏天，留在影像里"}</p>
...
/** 暑期影像：视频存在时可直接播放；未上传时自动退回真实项目故事图。 */
    ...
    <section id="summer-films" className="bg-shell section-block overflow-hidden">
      ...
      <div className="section-container relative z-10">
        <SectionHeader
          ...
          title="把那个夏天，留在影像里"
          subtitle="一段可播放的知行秦川，一场仍在继续的玉树赴约；镜头让真实行动被更多人看见。"
        />
